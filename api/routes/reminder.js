...
router.post('/', (req, res, next) => {
    Reminder.addReminder(req.body, function(err, result, fields) {
        if (err) {
...
router.put('/:reminderId', (req, res, next) => {
    Reminder.updateReminder(req.params.reminderId, req.body, function(err, rows){
        if (err) {
            const response = {"_meta":{"status_code": 417, "message": err}};
...
router.delete('/:reminderId', (req, res, next) => {
    Reminder.deleteReminder(req.params.reminderId, function(err, count) {
